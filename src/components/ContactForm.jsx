...
import twitter from '../../public/images/TwitterFollow.99d320e4.svg';
import Facebook from '../../public/images/Facebook.8f432841.svg'
import Linkedin from '../../public/images/Linkedin.213bb388.svg';
import Pinterest from '../../public/images/Pinterest.24dedd45.svg'
import b from '../../public/images/behanceFollow.8020f39c.svg';
import dribble from '../../public/images/dribbleFollow.57dc1fb5.svg';
import medium from '../../public/images/medium.e83b68d2.svg';
import India from '../../public/images/ind.png';


const countryOptions = [
    { value: 'IN', label: '🇮🇳 +91', flag: India },
    { value: 'US', label: '🇺🇸 +1', flag: India },
    { value: 'US', label: '🇺🇸 +1', flag: India },
];
            ...
            <div className="container mx-auto flex flex-col lg:flex-row p-4 items-start gap-12">
                ...
                <div className="lg:w-1/2 bg-gray-100 p-6 rounded-3xl shadow-lg relative -mt-2 -ml-2">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <button
                            type="submit"
                            className="w-full py-3 mt-4 bg-gradient-to-r from-orange-500 to-orange-700 text-white font-semibold  hover:bg-orange-700 transition-all duration-300 "
                        >
                            Submit
                        </button>
                    </form>
